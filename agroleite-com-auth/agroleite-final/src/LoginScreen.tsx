...
export default function LoginScreen({ onLogin }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f5] relative overflow-x-hidden font-sans flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-4 mt-2">
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-4">
            ...
            <h1 className="text-[40px] font-extrabold text-[#083F2B] tracking-tight leading-none mt-2">MooData</h1>
            ...
            <p className="text-[#168B5C] font-semibold mt-2 max-w-[280px] mx-auto leading-snug text-base">
              Dados que transformam sua produção em resultados.
            </p>
          </div>

          {/* Login Card */}
          <div className="bg-white rounded-[28px] p-7 w-full shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-white">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#083F2B] text-white rounded-xl py-3.5 font-bold text-[15px] hover:bg-[#062c1e] active:scale-[0.98] transition-all disabled:opacity-70 flex items-center justify-between px-6 mt-4 shadow-lg shadow-[#083F2B]/20"
              >
                <span></span>
              ...
              <button
                type="button"
                className="w-full bg-white border-2 border-slate-200 text-[#083F2B] rounded-xl py-3.5 font-bold text-[14px] hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
              >
                <UserPlus size={18} />
                Criar conta
              </button>
      ...
      <div className="relative z-10 pb-6 pt-2 px-4 mt-auto">
